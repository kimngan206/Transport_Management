  ...
  routes: [
    {
      ...
      name: 'login',
      component: LoginView,
      meta: { title: 'Đăng Nhập Vai Trò  Cao Su' },
    },
    {
      path: '/',
      name: 'root',
