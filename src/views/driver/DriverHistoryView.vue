    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">
          Nhật ký đối soát hành trình, quãng đường ODO, khối lượng mủ cao su và đối chiếu tiêu hao nhiên liệu từng chuyến
        </p>
      </div>
    </div>
      ...
      <div class="card-header-flex">
        ...
        <div class="search-box">
          ...
          <input
            v-model="searchQuery"
            type="text"
            placeholder="Tìm mã chuyến, biển số, tuyến đường..."
            class="form-input-sm"
          />
        </div>
      </div>
